...
insert into tb_produtos(produto, precoPorKg, tipo, marca, categoria_id) values ("Maminha", 70.00, "Natural", "Friboi", 1);
insert into tb_produtos(produto, precoPorKg, tipo, marca, categoria_id) values ("Salsicha", 13.00, "processado", "Perdigão", 3);
insert into tb_produtos(produto, precoPorKg, tipo, marca, categoria_id) values ("Patinho", 90.00, "natural", "Friboi", 2);
...
insert into tb_produtos(produto, precoPorKg, tipo, marca, categoria_id) values ("Presunto defumado", 20.00, "processado", "Sadia", 1);
