...
insert into tb_categorias(tipoProduto, descricao) values ("cosméticos", "Produtos para cuidados e beleza.");
insert into tb_categorias(tipoProduto, descricao) values ("remédios", "Produtos para tratamento médico.");
insert into tb_categorias(tipoProduto, descricao) values ("Higiene", "Produtos de higiene pessoal.");
...
insert into tb_produtos(produto, preco, tipo, publico, categoria_id) values ("Doralgina", 8.00, "sólido", "Adulto", 2);
insert into tb_produtos(produto, preco, tipo, publico, categoria_id) values ("Buscopan", 15.00, "sólido", "Adulto", 2);
...
insert into tb_produtos(produto, preco, tipo, publico, categoria_id) values ("Hidratante corporal", 30.00, "cremoso", "Adulto", 1);
